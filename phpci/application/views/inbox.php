    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		...
		?>
			...
			<a href="inbox" class="msgbox" title="进入我的留言箱">你有<em>0</em>新留言</a></span>
</div>
		<div id="SearchBar">
    		<form action="#">
...
<ul>
	...
	<span class="msg">
		<div class="outline">
			...
			发送于 昨天(23:00) <?php echo $v->ADD_TIME ?>				
			&nbsp;&nbsp;<a href="javascript:delete_in_msg(186720)">删除</a>
		</div>
		<div class="content">
		  <div class="c"><?php echo $v->CONTENT ?></div></div>
		<div class="opts">
...
$('.AutoCommitForm').ajaxForm({
    success: function(html) {	
		...
		if(html.length>0)
			...
			$('#error_).html("<span class='ok_msg'>操作已成功完成</span>")
		$('#error_msg').show("fast");
    }
});
